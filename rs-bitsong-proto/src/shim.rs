...
#[derive(Clone, PartialEq, Eq, Copy, ::prost::Message, schemars::JsonSchema)]
pub struct Duration {
...
/// Convert a list of `Coin` from bitsong proto generated proto `Coin` type to cosmwasm `Coin` type
...
/// Convert a list of `Coin` from cosmwasm `Coin` type to  bitsong proto generated proto `Coin` type
