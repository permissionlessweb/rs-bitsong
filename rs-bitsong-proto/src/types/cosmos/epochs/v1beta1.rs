...
#[proto_message(type_url = "/cosmos.epochs.v1beta1.EventEpochEnd")]
...
#[proto_message(type_url = "/cosmos.epochs.v1beta1.EventEpochStart")]
...
#[proto_message(type_url = "/cosmos.epochs.v1beta1.EpochInfo")]
...
#[proto_message(type_url = "/cosmos.epochs.v1beta1.GenesisState")]
...
#[proto_message(type_url = "/cosmos.epochs.v1beta1.QueryEpochInfosRequest")]
#[proto_query(
    path = "/cosmos.epochs.v1beta1.Query/EpochInfos",
    response_type = QueryEpochInfosResponse
)]
...
#[proto_message(type_url = "/cosmos.epochs.v1beta1.QueryEpochInfosResponse")]
...
#[proto_message(type_url = "/cosmos.epochs.v1beta1.QueryCurrentEpochRequest")]
#[proto_query(
    path = "/cosmos.epochs.v1beta1.Query/CurrentEpoch",
...
#[proto_message(type_url = "/cosmos.epochs.v1beta1.QueryCurrentEpochResponse")]
...
impl<'a, Q: cosmwasm_std::CustomQuery> EpochsQuerier<'a, Q> {
    ...
    pub fn epoch_infos(&self) -> Result<QueryEpochInfosResponse, cosmwasm_std::StdError> {
        QueryEpochInfosRequest {}.query(self.querier)
    }
