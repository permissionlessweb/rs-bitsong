...
pub const COSMOS_SDK_VERSION: &str = include_str!("prost/rs-bitsong-sdk/COSMOS_SDK_COMMIT");
...
pub mod bitsong {
    ...
    pub mod smartaccount {
        pub mod v1beta1 {
            include!("prost/rs-bitsong-sdk/bitsong.smartaccount.v1beta1.rs");
        }
    }
    // pub mod fantoken {
    //     pub mod v1beta1 {
    //         include!("prost/rs-bitsong-sdk/bitsong.fantoken.v1beta1.rs");
    //     }
    // }
    // pub mod cadence {
    //     pub mod v1beta1 {
    //         include!("prost/rs-bitsong-sdk/bitsong.cadence.v1.rs");
    //     }
    // }
